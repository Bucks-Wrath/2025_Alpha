...
public class ProcessorAutoCrawl extends Command {    
    private CommandSwerveDrivetrain drivetrain; 
    private SwerveRequest.FieldCentricFacingAngle crawlDrive;

    public ProcessorAutoCrawl(CommandSwerveDrivetrain drivetrain, SwerveRequest.FieldCentricFacingAngle crawlDrive) {
