...
public class RobotContainer {
    ...
    public static CommandXboxController driverController = new CommandXboxController(0); // changed to public static
    ...
    public RobotContainer() {
        ...
        drivetrain.setDefaultCommand(new TeleopDrive(drivetrain)); // relocated
